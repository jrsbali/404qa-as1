...
public class Hand implements Comparable {
	...
	/**
	 * returns the highest ranking card on hand. ACE is the highest
	 * 
	 * @return
	 */
	...
	/**
	 * if the set of all the integers has the cardinality of at least 3 then it
	 * has 2 pairs
	 * 
	 * @return
	 */
	...
	/**
	 * gets the rank of the hand e.g. RoyalFlush, Flush, Straight etc..
	 * 
	 * @return
	 */
	...
	/**
	 * Creates an array in sorted order (descending) of the ranks of the hand
	 * 
	 * @return
	 */
